...
const AboutOverlay = ({ isOpen, onClose }: AboutOverlayProps) => {
    ...
    return (
        ...
        >
            <button 
                onClick={onClose} 
                className="close-btn fixed top-5 right-5 md:top-8 md:right-8 z-[220] text-black hover:text-black/80 hover:rotate-90 transition-transform duration-300 hover:scale-110 active:scale-95 flex items-center justify-center"
                data-cursor="hover"
            >
